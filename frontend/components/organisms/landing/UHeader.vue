...
<template>
    <div class="fixed top-3 w-full z-10 px-4 sm:px-6">
            ...
            >
                <div class="flex items-center gap-3 rounded-lg hover:bg-primary-hover p-2 cursor-pointer" @click="navigateTo('/')">
                    <ULogo class="size-8" />
                ...
                <nav class="hidden md:block flex-grow mx-4">
                    <ul class="flex items-center gap-6">
                        <li><ULink to="#" variant="secondary">Product</ULink></li>
                        <li><ULink to="#" variant="secondary">About</ULink></li>
                        <li><ULink to="#" variant="secondary">Pricing</ULink></li>
                    </ul>
                </nav>
                ...
                <div v-if="!authStore.isAuthenticated" class="hidden md:flex items-center gap-3">
                    <UButton variant="secondary" @click="navigateTo('/login')">Log in</UButton>
            ...
            >
                <nav class="flex flex-col space-y-6">
                    ...
                    <div class="flex flex-col space-y-3 pt-4 border-t border-secondary">
                        <UButton v-if="!authStore.isAuthenticated" variant="secondary" class="w-full" @click="navigateTo('/login')">Log in</UButton>
