...
Salair se compromete a proteger tus datos personales en cumplimiento con el Reglamento General de Protección de Datos (RGPD).
...
- Datos de uso (estadísticas, logs, uso de funciones)
...
No se transfieren datos fuera de la UE sin garantías adecuadas.

## 6. Periodo de conservación

Los datos se conservan mientras tu cuenta esté activa, y luego durante 5 años por obligaciones legales.

## 7. Seguridad

Salair aplica medidas técnicas y organizativas como cifrado, control de acceso y auditorías.
...
Utilizamos cookies para mejorar tu experiencia y obtener estadísticas. Puedes aceptarlas o rechazarlas mediante el banner correspondiente.
